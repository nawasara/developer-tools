<div x-data="{ open: @entangle('isOpen') }">
    ...
    <div x-show="open" x-transition.opacity x-transition.scale.origin.bottom.right
        class="fixed bottom-24 right-6 w-80 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl z-50 border border-gray-200 dark:border-gray-800 overflow-hidden"
        style="box-shadow: 0 10px 25px rgba(0,0,0,0.15);">
        <div
            class="bg-blue-600 dark:bg-blue-700 text-white px-4 py-3 font-semibold flex justify-between items-center rounded-t-2xl">
            <span class="tracking-wide">Developer Tools</span>
        ...
        <div class="p-5 max-h-96 overflow-y-auto">
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                <button wire:click="runMigrateFresh" wire:loading.attr="disabled"
                    class="bg-red-500 hover:bg-red-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runMigrateFreshSeed" wire:loading.attr="disabled"
                    class="bg-red-600 hover:bg-red-700 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runDbSeed" wire:loading.attr="disabled"
                    class="bg-green-500 hover:bg-green-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runVendorPublish" wire:loading.attr="disabled"
                    class="bg-purple-500 hover:bg-purple-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runClearCache" wire:loading.attr="disabled"
                    class="bg-yellow-500 hover:bg-yellow-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runRouteClear" wire:loading.attr="disabled"
                    class="bg-blue-500 hover:bg-blue-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runOptimize" wire:loading.attr="disabled"
                    class="bg-indigo-500 hover:bg-indigo-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
                ...
                <button wire:click="runStorageLink" wire:loading.attr="disabled"
                    class="bg-pink-500 hover:bg-pink-600 text-white text-xs py-2 px-3 rounded-lg shadow-sm transition disabled:opacity-50">
            ...
            @if ($output)
                <div class="mt-4 border-t pt-3">
                    ...
                    <div
                        class="bg-gray-100 dark:bg-gray-800 p-3 rounded text-xs font-mono whitespace-pre-wrap overflow-x-auto max-h-40 text-gray-800 dark:text-gray-100">
                        {{ $output }}
                    </div>
                </div>
            @endif
